...
public class InstanciarComunicadorCorrectlyProperty  extends PropertyListenerAdapter {
	private int count = 0;   
	...
	public void instructionExecuted(JVM vm) {
		...
		if (!ListenerUtils.filter(instruction)) {
			if (instruction.getSourceLine().trim().contains("Comunicador") && mi.getFullName().contains("Comunicador")) {
				count ++;
                	}
		}
	} 
